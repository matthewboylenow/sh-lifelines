...
export const registerSchema = z.object({
  ...
  // Backward compat: accept single role and convert
...
export const createLifeLineSchema = z.object({
  ...
  agesStages: z.array(z.string()).optional().default([]),
  meetingFrequency: z.nativeEnum(MeetingFrequency).optional().nullable(),
  ...
  childcare: z.boolean().optional().default(false),
  status: z.enum(['DRAFT', 'PUBLISHED', 'FULL', 'ARCHIVED']).optional().default('DRAFT'),
